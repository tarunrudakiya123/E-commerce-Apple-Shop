      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <TextField
            ...
            label="first Name"
            type="text"
            helperText={typeof error === 'string' && error.includes("firstName") ? error : ""}
            error={typeof error === 'string' && error.includes("firstName")}
            onChange={(e) =>
          ...
          <TextField
            ...
            helperText={typeof error === 'string' && error.includes("lastName") ? error : ""}
            error={typeof error === 'string' && error.includes("lastName")}
            label="Last Name"
            type="text"
            fullWidth
            variant="outlined"
          ...
          <TextField
            ...
            helperText={typeof error === 'string' && error.includes("email") ? error : ""}
          ...
          <FormControl sx={{ marginTop: "10px" }}>
            ...
            <Select
              ...
              label="Role"
              helperText={typeof error === 'string' && error.includes("role") ? error : ""}
              error={typeof error === 'string' && error.includes("role")}
              margin="dense"
              onChange={(e) =>
          ...
          <TextField
            ...
            helperText={typeof error === 'string' && error.includes("password") ? error : ""}
