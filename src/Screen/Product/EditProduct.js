  ...
  const updateProductDetails = async () => {
    try {
      ...
      if (ValidationResult.length > 0) {
        setproductDetailsError(ValidationResult);
      }
      setIsSubmited(false);
      ...
      <div className="row mt-3">
        <div className="col-12 col-md-3">
          ...
          <TextField
            ...
            error={productDetailsError.find((x) => x.key === "name")}
            helperText={productDetailsError.find((x) => x.key === "name")?.message}
        ...
        <div className="col-12 col-md-2">
          ...
          <TextField
            ...
            id="product_Brand"
            placeholder="Brand"
            error={productDetailsError.find((x) => x.key === "brand")}
            helperText={productDetailsError.find((x) => x.key === "brand")?.message}
        ...
        <div className="col-12 col-md-3">
          ...
          <TextField
            ...
            type="text"
            placeholder="Alias"
            error={productDetailsError.find((x) => x.key === "alias")}
            value={ProductDetails.alias}
            helperText={productDetailsError.find((x) => x.key === "alias")?.message}
            onChange={(e) => {
        ...
        <div className="row mt-3">
          <div className="col-12 col-md-8">
            ...
            <Editor
              ...
              error={productDetailsError.find((x) => x.key === "description")}
              helperText={productDetailsError.find((x) => x.key === "description")?.message}
          ...
          <div className="col-12 col-md-4">
            ...
            <TextField
              ...
              label="Price"
              type="number"
              error={productDetailsError.find((x) => x.key === "price")}
              helperText={productDetailsError.find((x) => x.key === "price")?.message}
              onChange={(e) => {
            ...
            <TextField
              ...
              error={productDetailsError.find((x) => x.key === "countInStock")}
              helperText={productDetailsError.find((x) => x.key === "countInStock")?.message}
              className="w-100 mt-3"
              label="countInstock"
              type="number"
              onChange={(e) => {
