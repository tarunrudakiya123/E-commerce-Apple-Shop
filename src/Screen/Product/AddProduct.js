      ...
      <div className="row mt-3">
        <div className="col-12 col-md-3">
          ...
          <TextField
            ...
            helperText={
              productDetailsError.find((x) => x.key === "name")?.message
            }
            onChange={(e) => {
        ...
        <div className="col-12 col-md-2">
          ...
          <TextField
            ...
            helperText={
              productDetailsError.find((x) => x.key === "brand")?.message
            }
            onChange={(e) => {
        ...
        <div className="col-12 col-md-3">
          ...
          <TextField
            ...
            helperText={
              productDetailsError.find((x) => x.key === "alias")?.message
            }
            onChange={(e) => {
        ...
        <div className="row mt-3">
          <div className="col-12 col-md-8">
            ...
            <Editor
              ...
              helperText={
                productDetailsError.find((x) => x.key === "description")
                  ?.message
              }
              ...
              init={{
                ...
                images_upload_handler: async (
                  ...
                  const body = formdata;
                  const data = await axios.post("http://localhost:5000/admin/upload/file",body);
                  if (data.status === 200) {
          ...
          <div className="col-12 col-md-4">
            ...
            <TextField
              ...
              type="number"
              helperText={
                productDetailsError.find((x) => x.key === "price")?.message
              }
              onChange={(e) => {
                setProductDetails({
                  ...ProductDetails,
            ...
            <TextField
              ...
              helperText={
                productDetailsError.find((x) => x.key === "countInStock")
                  ?.message
              }
              className="w-100 mt-3"
              inputMode="numeric"
